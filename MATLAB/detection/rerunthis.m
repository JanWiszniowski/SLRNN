...
[onetNNA3,oerrNNA3] = recompute_tdnn_for_nntool2(inetAll, pureDataNNA3, 'no iterations',5 , 'max random',25, 'cat at the begin', 65, 'max length', 300, 'no tests',6, 'no kept tests',4);
clear pureDataNNA3
save SRNN_LAICHAU_temp
